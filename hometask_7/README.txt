...
Она должна уметь генерировать справочник и сохранять его в файл при необходимости (экспорт) или загружать (импорт). 
...
2. Контроллер
3. Ввод данных, работа с пользователем (UI)
4. Модуль работы со справочником (program_work)
